...
## **A. 목차**
  ...
  * B. [프로젝트 진행](#b-프로젝트-진행)
    ...
    * B.2. [주요 액션](#b2-주요-액션)
      ...
      * B.2.6. [딥러닝 모델을 이식한 검수 절차 구축 및 PC APP 개발](#b26-딥러닝-모델을-이식한-검수-절차-구축-및-pc-app-개발)
  * C. 결과 및 기대효과
  * D. Deck
  * E. Methods Used
--- 
...
<a href="https://youtu.be/T3MaxBySd3U/" target="_blank"><img alt="youtube_link" width = 80% height = 80% src="http://github.com/TAEJIN-AHN/AI-Doll-Inspection/assets/125945387/0507e2dd-32ef-46fc-afd7-810b37a8d506" /></a>

[<img alt="youtube_link" width = 80% height = 80% src="http://github.com/TAEJIN-AHN/AI-Doll-Inspection/assets/125945387/0507e2dd-32ef-46fc-afd7-810b37a8d506" />](https://youtu.be/T3MaxBySd3U){:target="_blank"}

[![video_link_image](http://github.com/TAEJIN-AHN/AI-Doll-Inspection/assets/125945387/0507e2dd-32ef-46fc-afd7-810b37a8d506)](https://youtu.be/T3MaxBySd3U)
...
<table align = 'center'>
 ...
 <tr>
  <!--<td>행동 판단 조건 </td>-->
  <td>각 단계에서 필요로 하는 동작을 탐지한 프레임의 수가 전체 중 일정 비율 이상일 시 행동을 수행하였다고 판단한다</td>
 </tr>
 <tr>
  <!--<td>행동 판단 조건 </td>-->
