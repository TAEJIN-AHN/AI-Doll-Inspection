...
* 본 프로젝트에서는 판매자가 정해진 절차에 따라 물품의 모든 면을 촬영하고 딥러닝 모델이 제품의 상태와 손동작을 확인하는 검수 절차를 구축하여 플랫폼의 업무 과중을 줄이고 거래의 신뢰도를 높이고자 함
...
* 윗면과 아랫면을 보여주는 손동작에서는 Mediapipe를 통한 손 랜드마크 검출이 어려워 LSTM 모델을 사용하지 않음
